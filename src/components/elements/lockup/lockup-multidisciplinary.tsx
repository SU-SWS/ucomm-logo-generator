...
const LockupMultidisciplinary = ({line1, line2}: LockupProps) => {
  ...
  return (
    <svg id="generated-logo" xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${width} 33`}>
      <g fill="#8c1515">
      ...
      <g style={{fontFamily: "SourceSans3-Regular, 'Source Sans 3'", fontSize: "12.75px", letterSpacing: 0}}>
        <text ref={textRef} x={79.67} y={15.14}>
          {line1}
        </text>
        <text
          style={{
            fontFamily: "SourceSans3-SemiBold, 'Source Sans 3'",
            fontSize: "8.25px",
            fontWeight: 600,
          }}
          x={-0.53}
